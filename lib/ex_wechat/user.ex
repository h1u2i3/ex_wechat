defmodule ExWechat.User do
  @moduledoc """
  Module to operate with user.
  """
  alias ExWechat.User.Info
  alias ExWechat.User.Group

  @doc """
  Get user info from server.
  """
  def info(module \\ ExWechat, openid)
  ...
  """
  def group_user_add(module \\ ExWechat, openid, group)
